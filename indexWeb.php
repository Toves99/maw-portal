 ...
 // 
    ...
    if($num_rows>0){
      if(password_verify($password,$fetch_data['password'])){
        ...
        echo "<script>window.open('webApplicationCourses.php','_self')</script>";
    }else{
      ...
      // $messageToUser="Invalid credentials";
        echo "<script>alert('Invalid credentials')</script>";
        echo "<script>window.open('indexWeb.php','_self')</script>";
    }
}
?>
<!DOCTYPE html>
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        <div class="content">
          ...
          <br>
          <a href="signUpWeb.php" class="btn transparent" id="sign-in-btn" style="padding:10px 20px;text-decoration:none;
