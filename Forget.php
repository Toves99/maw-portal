...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM users WHERE email='{$email}'")) > 0) {
        $query = mysqli_query($conn, "UPDATE users SET CodeV='{$CodeReset}' WHERE email='{$email}'");
        if ($query) {
            ...
            try {
                ...
                $mail->Body    = '<p> This is the Verifecation Link<b><a href="https://be49-196-216-86-67.ngrok-free.app/coursephp/P1/Sliding/change-Password.php?Reset=' . $CodeReset . '">"https://be49-196-216-86-67.ngrok-free.app/coursephp/P1/Sliding/change-Password.php?Reset=' . $CodeReset . '"</a></b></p>';
