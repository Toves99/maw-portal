 ...
 // 
    ...
    if($num_rows>0){
      if(password_verify($password,$fetch_data['password'])){
        ...
        echo "<script>window.open('shortCourses.php','_self')</script>";
    }else{
      ...
      // $messageToUser="Invalid credentials";
        echo "<script>alert('Invalid credentials')</script>";
        echo "<script>window.open('indexShortCourses.php','_self')</script>";
    }
}
?>
<!DOCTYPE html>
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        <div class="content">
          ...
          <br>
          <a href="signUpShortCourses.php" class="btn transparent" id="sign-in-btn" style="padding:10px 20px;text-decoration:none;
