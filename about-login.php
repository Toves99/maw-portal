...
<head>
  ...
  <link href="assets/css/about-login1.css" rel="stylesheet">
  <style>
  #h4 {
    margin-top: 30px;
    margin-left: 20px;
      ...
      <nav id="navbar" class="navbar">
        <ul>
           <li class="dropdown"><a href="#"><span>Our Courses</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            ...
            <li><a href=" https://788d-196-216-86-82.ngrok-free.app/maw/mylearning.php">My learning</a></li>
            <li><a href=" https://788d-196-216-86-82.ngrok-free.app/maw/contact-login.php">Contact</a></li>
          </li>
          
          <li class="dropdown"><a href="#"><span>More</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              <li><a href="#about">About Us</a></li>
              <li><a href="https://2a6d-102-220-12-50.ngrok-free.app/maw/career-login.php">Career</a></li>
